...
export const EXPERIENCE_LIST: ExperienceType[] = [
  {
    ...
    responsibilities: [
      ...
      {
        text: 'Foster clear team communication to meet project goals employing agile methods.',
      },
    ],
    accomplishments: [
      {
        text: 'Enhanced website performance and user satisfaction across multiple projects.',
      },
    ],
    mainTechStack: [{ text: 'React.js' }, { text: 'Next.js' }],
    current: true,
    jobType: 'freelance',
  },
  {
